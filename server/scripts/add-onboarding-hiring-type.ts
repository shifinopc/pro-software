    ...
    { id: "profile", type: "task", label: "Create Employee Profile", config: {
      ...
      rules: [
        { when: { var: "nationality", op: "matches", value: "^\s*saudi" },
          ...
          message: "A Saudi national cannot be onboarded on an expatriate path — a work visa, Iqama and work permit are for foreign nationals. Set Hiring type to Saudi national, or correct the nationality." },
        { when: { var: "hiringType", op: "eq", value: "saudi_national" },
          then: { var: "nationality", op: "matches", value: "^\s*saudi" },
          message: "The Saudi national path needs a Saudi nationality — an expatriate needs a visa or a Qiwa transfer. Correct the nationality, or change Hiring type to Expat new hire or Expat transfer." },
        { when: { var: "hiringType", op: "eq", value: "expat_new_hire" },
          then: { var: "currentLocationStatus", op: "in", value: "outside_ksa" },
          message: "A new expatriate hire is recruited from outside the Kingdom — somebody already inside it is a Qiwa transfer. Set Currently to Outside KSA, or change Hiring type to Expat transfer." },
        { when: { var: "hiringType", op: "eq", value: "expat_transfer" },
          then: { var: "currentLocationStatus", op: "in", value: "inside_ksa" },
          message: "A Qiwa employee transfer moves somebody already working inside the Kingdom. Set Currently to Inside KSA, or change Hiring type to Expat new hire." },
      ],
      captures: [
