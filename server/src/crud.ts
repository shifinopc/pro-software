 ...
 */
export const COUNTRY_SCOPED_CONFIG = ["documentType", "workflowTemplate", "serviceItem", "package", "checklistRule", "workforceBandSet", "workforceBand", "pipelineStage", "leadSource", "lostReason", "courierJobType", "appointmentType", "courierStatus", "appointmentStatus"];
 ...
 */
export const RETIREABLE = ["documentType", "workflowTemplate", "serviceItem", "package", "checklistRule", "govCenter", "workforceBandSet", "workforceBand", "pipelineStage", "leadSource", "lostReason", "courierJobType", "appointmentType", "courierStatus", "appointmentStatus"];
